...
class main_proj_wifi_rx_week_8(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "main_proj_wifi_rx_week_8")
        ...
        self._window_size_options = [48, 64, 128, 256, 512]
        # Create the labels list
        self._window_size_labels = ['48', '64', '128', '256', '512']
        # Create the combo box
        self._window_size_tool_bar = Qt.QToolBar(self)
        self._window_size_tool_bar.addWidget(Qt.QLabel("Window Size" + ": "))
        ...
        # Create the options list
        self._Gain_options = [20, 30, 40, 50, 60]
        # Create the labels list
        self._Gain_labels = ['20 dB', '30 dB', '40 dB', '50 dB', '60dB']
        # Create the combo box
        self._Gain_tool_bar = Qt.QToolBar(self)
        self._Gain_tool_bar.addWidget(Qt.QLabel("Gain" + ": "))
        self._Gain_combo_box = Qt.QComboBox()
        self._Gain_tool_bar.addWidget(self._Gain_combo_box)
        for _label in self._Gain_labels: self._Gain_combo_box.addItem(_label)
        self._Gain_callback = lambda i: Qt.QMetaObject.invokeMethod(self._Gain_combo_box, "setCurrentIndex", Qt.Q_ARG("int", self._Gain_options.index(i)))
        self._Gain_callback(self.Gain)
        self._Gain_combo_box.currentIndexChanged.connect(
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/tmp/wifi_pluto_week8.pcap', False)
...
def main(top_block_cls=main_proj_wifi_rx_week_8, options=None):
