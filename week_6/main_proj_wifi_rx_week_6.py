...
class main_proj_wifi_rx_week_6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "main_proj_wifi_rx_week_6")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/tmp/wifi_pluto_week6.pcap', False)
...
def main(top_block_cls=main_proj_wifi_rx_week_6, options=None):
